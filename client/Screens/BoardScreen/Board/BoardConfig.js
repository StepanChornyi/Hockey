...
const PLAYER_A_START = new Vector(BOARD_CENTER.x, GATES_SIZE * 0.5);
const PLAYER_B_START = new Vector(BOARD_CENTER.x, BOARD_HEIGHT - GATES_SIZE * 0.5);

const BALL_A_RESET = new Vector(BOARD_CENTER.x, BOARD_CENTER.y - GATES_SIZE * 0.5);
const BALL_B_RESET = new Vector(BOARD_CENTER.x, BOARD_CENTER.y + GATES_SIZE * 0.5);
